...
import { ComfirmDialogService } from 'src/app/core/services/comfirm-dialog.service'
...
export class CutComponent implements OnInit {
  ...
  public async pivoter (page: any, document: CutResponse): Promise<void> {
